...
func TestBodyParse(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, r)
	assert.Equal(t, "This is my message to the world\n", string(r.Body))
}
